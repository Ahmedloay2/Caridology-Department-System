...
namespace Caridology_Department_System.Migrations
{
    ...
    [Migration("20250427183146_First Migration")]
            ...
            modelBuilder.Entity("Caridology_Department_System.Models.AdminModel", b =>
                {
                    b.HasOne("UserModel", null)
                        .WithOne()
                        .HasForeignKey("Caridology_Department_System.Models.AdminModel", "ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Caridology_Department_System.Models.DoctorModel", b =>
                {
                    b.HasOne("UserModel", null)
                        .WithOne()
                        .HasForeignKey("Caridology_Department_System.Models.DoctorModel", "ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Caridology_Department_System.Models.PatientModel", b =>
                {
                    b.HasOne("UserModel", null)
                        .WithOne()
                        .HasForeignKey("Caridology_Department_System.Models.PatientModel", "ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
